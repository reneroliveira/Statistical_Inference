...
\begin{document}
	...
	\begin{col}
		...
		\begin{align}
		\label{col1}
		 g(t|\theta_1)\gt kg(t|\theta_0)\implies t\in S\nonumber\\ \\\text{ e }g(t|\theta_1)< kg(t|\theta_0)\implies t\in S\pow C,\nonumber
		\end{align}
	...
	\begin{align*}
		&g(T(\bx)|\theta_1)\gt kg(T(\bx)|\theta_0)\\
		\Leftrightarrow&
		g(T(\bx)|\theta_1)u(\bx)\gt kg(T(\bx)|\theta_0)u(\bx)\\
		\Leftrightarrow&f_n(\bx|\theta_1)\gt kf_n(\bx|\theta_0)
	\end{align*}
	
	Assim, tem-se: $f_n(\bx|\theta_1)\gt kf_n(\bx|\theta_0)\implies T(\bx)\in S\implies \bx \in R$.
	
	Analogamente, $f_n(\bx|\theta_1)< kf_n(\bx|\theta_0)\implies \bx \in R\pow C$.
